...
const en: Dict = {
  ...
  'tr.hint': 'Speech in the room is translated to English in short takes, a few seconds behind.',
  ...
  'tr.cfgTake': 'Take length',
  'tr.cfgTakeNote': 'Shorter takes arrive sooner but cut phrases more often; longer ones read better and lag more.',
  'voice.you': 'you',
...
const uk: Dict = {
  ...
  'tr.hint': 'Мова в кімнаті перекладається англійською короткими шматками, із затримкою в кілька секунд.',
  ...
  'tr.cfgTake': 'Довжина дубля',
  'tr.cfgTakeNote': 'Коротший дубль приходить швидше, але частіше ріже фразу; довший читається краще і більше відстає.',
  'voice.you': 'ви',
