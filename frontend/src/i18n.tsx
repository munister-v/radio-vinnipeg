...
const en: Dict = {
  ...
  'crime.heading': 'American True Crime',
  'crime.sub': 'Courtroom video and case podcasts from Court TV, Law&Crime, Dateline NBC, 48 Hours and Crime Junkie — pulled straight from their public feeds.',
...
const uk: Dict = {
  ...
  'crime.heading': 'American True Crime',
  'crime.sub': 'Відео із залів суду й подкасти про справи: Court TV, Law&Crime, Dateline NBC, 48 Hours і Crime Junkie — прямо з їхніх публічних стрічок.',
