...
const en: Dict = {
  ...
  'promo.title': 'Pyrokinesis and the maniacs of North America',
  'promo.lead': 'Two hours on fire that starts without a match: the myth of pyrokinesis, the arson files it grew out of, and the North American serial cases where fire was the signature — from the burned-out houses of the prairies to the courtrooms that had to explain them. Open mic afterwards: bring your own case.',
...
const uk: Dict = {
  ...
  'promo.title': 'Пірокінез і маніяки Північної Америки',
  'promo.lead': 'Дві години про вогонь, що починається без сірника: міф про пірокінез, справи про підпали, з яких він виріс, і північноамериканські серійні справи, де вогонь був підписом — від згорілих будинків прерій до залів суду, які мусили це пояснити. Далі відкритий мікрофон: приходьте зі своєю справою.',
  ...
  'crime.sub': 'Відео із залів суду й подкасти про справи: Court TV, Law&Crime, Dateline NBC, 48 Hours, Crime Junkie, а з канадського — CBC: The Fifth Estate, Uncover, Someone Knows Something. Прямо з їхніх публічних стрічок.',
