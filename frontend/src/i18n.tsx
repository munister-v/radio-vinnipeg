...
const en: Dict = {
  ...
  'promo.sourcesNote': 'Public documents and research we read on air. Names are links to the originals, not endorsements.',
...
const uk: Dict = {
  ...
  'promo.sourcesNote': 'Публічні документи й дослідження, які читаємо в ефірі. Назви ведуть на оригінали, це не партнерство.',
